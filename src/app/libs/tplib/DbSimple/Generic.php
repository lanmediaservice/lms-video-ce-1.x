 ...
 * 
 * @version 2.x $Id: Generic.php 186 2007-04-12 07:38:36Z dk $
 */
...
class DbSimple_Generic_Database extends DbSimple_Generic_LastError
{
    ...
    {
        die("Method must be defined in derived class. Abstract function called at Generic.php line ".__LINE__);
    }
    ...
    {
        die("This is protected constructor! Do not instantiate directly at Generic.php line ".__LINE__);
    }
