                    ...
                    <div class="control-panel" id="control_panel">
                        <div class="tab-selector">
                            <ul>
                                ...
                                <li class="settings" style="display: none;"><a href="#/settings">Настройки</a></li>
                                    ...
                                    <div class="panel">
                                       <a onclick="window.action.checkUpdates();" class="toolbar-button"><span>Проверить обновления</span></a>
                                        <div class="links">
                                            ...
                                            <a href="https://github.com/lanmediaservice/lms-video-ce-1.x" target="_blank">Репозиторий GitHub</a>
                                        </div>
                                    </div>
                                </div>
